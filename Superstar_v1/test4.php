...
<head>
    ...
    <style type="text/css">
        ...
        body {
            ...
            font-weight: 400;
            background: white;
            /* background: linear-gradient(90deg, rgba(14,44,63,1) 0%, rgba(88,121,135,1) 35%, rgba(118,131,137,1) 100%); */
        }
            ...
            <div class="container">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-item nav-link" data-toggle="dropdown">Manager</a>
                            <div class="dropdown-menu">
                                <a href="manager_login.php" class="dropdown-item">Login</a>
