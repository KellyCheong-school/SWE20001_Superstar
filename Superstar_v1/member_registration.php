...
<body class="img" style="background-image: url(images/bg.jpg);">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_num_rows($checkUniqueResult) > 0) {
            ...
            $infoMsg = "Error: Username already exists. Please choose a different username .";
        } else {
            ...
            $sql = "INSERT INTO members (username, password, full_name, dob, email, phone) VALUES ('$username', '$password', '$fullName', '$dob', '$email', '$phone')";
                        ...
                        <form action="#" class="signin-form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="form-group">
                                <input type="text" name="full_name" id="full_name" class="form-control"
                                    pattern="^[A-Za-z\s]+$" placeholder="Full name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="phone" id="phone" class="form-control"
                                    pattern="^60-([0-9]{8}|[0-9]{9})$" placeholder="Phone Number (60-123456789)"
                                    required>
                            </div>
                            <div class="form-group">
                                <input id="password-field" name="password" type="password" class="form-control"
                                    pattern=".{6,}" placeholder="Password (Minimum 6 characters)" required>
